...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(date) => "Dernière modification: ${date}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "errorEmptyTitle": MessageLookupByLibrary.simpleMessage(
      "Veuillez écrire le titre de la note!",
    ),
    "errorEmptyTitleAndDesc": MessageLookupByLibrary.simpleMessage(
      "Veuillez d\'abord écrire un titre et des détails!",
    ),
